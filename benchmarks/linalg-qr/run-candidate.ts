// =============================================================================
// benchmarks/linalg-qr/run-candidate.ts — corpus-resident bench adapter
// =============================================================================
//
...
//
// Mirrors bench/linalg-qr/run-candidate.ts in the workbench.
...
const out = await wb.run("linalg-qr", input) as V;
